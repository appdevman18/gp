...
@section('content')
                        ...
                        <div class="card card-info">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="urlForCheck" class="form-control" id="urlForCheck"
                                               placeholder="Enter Url For Check" value="{{ $product->url ?? '' }}"
                                               readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="store" class="form-control" id="store"
                                               placeholder="Store" value="{{ $product->store ?? '' }}"
                                               readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    <!-- /.content-wrapper -->
    <script>
        const dataPrices = <?php echo json_encode($product->prices); ?>;
        const priceValue = [];
        const priceDate = [];
