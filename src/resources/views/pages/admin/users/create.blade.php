                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="account" name="account"
                                                    class="form-control">@foreach(\App\Enums\UserAccount::cases() as $account)
                                                    <option
                                                        value="{{ $account->value }}" {{ $account->value != old('account') ?: 'selected' }}>{{ $account->value }}</option>@endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="status" name="status"
                                                    class="form-control">@foreach(\App\Enums\UserStatus::cases() as $status)
                                                    <option
                                                        value="{{ $status->value }}" {{ $status->value != old('status') ?: 'selected' }}>{{ $status->value }}</option>@endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
