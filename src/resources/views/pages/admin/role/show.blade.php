                        ...
                        <div class="card card-info">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control" id="name" placeholder="Name" value="{{ $role->name ?? '' }}" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="slug" class="col-sm-2 col-form-label">{{ __('Slug') }}</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="slug" class="form-control" id="slug" placeholder="Slug" value="{{ $role->slug ?? '' }}" readonly="readonly">
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="permissions" class="col-sm-2 col-form-label">{{ __('Permissions') }}</label>
                                        <div class="col-sm-10">
                                            <select  id="permissions" class="form-control" name="permissions[]" multiple="multiple" disabled>
                                    ...
                                    <div class="card-footer">
                                        <a href="{{ route('roles.edit', $role) }}" name="editRole" class="btn btn-success">{{ __('Edit') }}</a>
                                    </div>
                                </div>
